...
<head>
    ...
    <title>Sistema de gestión BD - Modulo de actualización de Países</title>
</head>
<body>
    <?php
    ...
    if (isset($_GET['Enviar'])) {
        ...
        if ($conn==true){
            ...
            try {
				$sql = "CALL actualizar_pais($id, '$nombre_pais', '$nombre_continente', $poblacion, '$moneda', '$idioma', $pib, '$actividad');";
