...
<head>
    ...
    <title>Sistema de gestión BD - Modulo de actualización de Continentes</title>
</head>
<body>
    <?php
    ...
    if (isset($_GET['Enviar'])) {
        ...
        if ($conn==true){
            ...
            $id = $_GET['id_continente'];
            $nombre_continente = $_GET['Nombre_continente'];
            $expansion = $_GET['expansion'];
            $porcentaje = $_GET['porcentaje'];

            try {
				$sql = "CALL actualizar_continente($id, '$nombre_continente', $expansion, $porcentaje, @status);";
                ...
                if ($stmt->execute()){
                    ...
                    if ($status == 1) {
                        echo "<h4>Datos actualizados en la BD con éxito</h4>";
                        ...
                        echo "<h4>Error, los datos no han podido ser actualizados en la BD debido a que el continente $nombre_continente ya existe</h4>";
                        echo "<p>Haga <a href='../continentes.php'>Volver</a></p>";
                    }else {
                        echo "<h4>Error, los datos no han podido ser actualizados en la BD debido a que el continente solicitado contiene datos anidados</h4>";
                        echo "<p>Haga <a href='../continentes.php'>Volver</a></p>";
                    }
                } else{
                    print_r($stmt->errorInfo());
                    echo "<h4>Error, los datos no han podido ser actualizados en la BD</h4>";
                }
        ...
        echo "<p>Para enviar datos por medio del formulario haga <a href='../continentes.php'>click aquí</a></p>";
    }
